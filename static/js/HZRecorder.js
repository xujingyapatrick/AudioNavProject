(function (window) {
    ...
    var HZRecorder = function (stream, config) {
        ...
        //回放
        this.play = function (audio, audioName) {
        ...
        //上传
        this.upload = function (preName, callback) {
            var fd = new FormData();
            fd.append("preName",preName);
            // fd.append("sss",preName);
            // console.log("this.getBlob()");
            // console.log(this.getBlob());
            console.log("this.getBlob()+1");
            fd.append("audioData", this.getBlob());
            console.log("this.getBlob()+2");
            console.log(fd);
            
            var url='http://192.168.1.220:5000/api/v1/audio';
            var xhr = new XMLHttpRequest();
            if (callback) {
